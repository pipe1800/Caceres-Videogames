-- Adjust stock management to reserve inventory at order creation and
-- release it when orders are cancelled.

-- Clean up previous triggers and helper functions
...
-- Reserve stock the moment an order is inserted
...
-- Restore stock if an order moves into a cancelled state
...
-- Bind the new helpers to the orders table
